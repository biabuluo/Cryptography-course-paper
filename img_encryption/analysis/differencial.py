...
# from BCIEA.encrypt import encrypt
# from teng.encrypt import encrypt
...
def differencial(img_path):
    ...
    img1, _ = encrypt(img_path)
    img2, _ = encrypt(img_path_2)
    npcr = NPCR(img1, img2)
    print('=================差分攻击=================')
    # 百分数表示，保留小数点后4位
...
if __name__ == '__main__':
    ...
    # img_path = '../images/grey/med.png'
    # differencial(img_path)
    # img_path = '../images/grey/blonde.jpg'
    # differencial(img_path)
    img_path = '../images/grey/darkhair.jpg'
    differencial(img_path)
    img_path = '../images/grey/livingroom.jpg'
    differencial(img_path)
    img_path = '../images/grey/mandril.jpg'
    differencial(img_path)
